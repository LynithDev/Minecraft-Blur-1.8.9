package dev.lynith.blurmod.shader
...
class Shader(
    ...
    companion object {
        ...
        val DEFAULT_VERTEX_SHADER = createShaderFromPath("/assets/blurmod/shaders/default.vsh", Shader.VERTEX)

        fun createShaderFromPath(path: String, type: Int): Shader {
            val source = Shader::class.java.getResource(path)?.readText() ?: throw RuntimeException("Failed to load shader source from $path")
